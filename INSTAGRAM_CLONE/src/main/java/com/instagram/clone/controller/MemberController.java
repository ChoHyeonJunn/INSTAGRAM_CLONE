...
public class MemberController {
	...
	private Map<String, Object> updateProfileImage(HttpServletRequest request, HttpSession session) {
		...
		member_profile.setMember_profile_image_name(MEMBER_PROFILE_IMAGE_NAME);
		member_profile.setMember_profile_image_s_name(MEMBER_PROFILE_IMAGE_S_NAME);
		member_profile.setMember_profile_image_path(FILE_PATH);
		...
		map.put("res", res);
		map.put("img", biz.selectMemberProfile(member_code).getMember_profile_image_s_name());
		return map;
	}
