...
<head>
	...
	function join(){
		...
		if(member_email == null || member_email == "" 
				...
				|| member_pw == null || member_pw == ""){
			
			alert("EMAIL, NAME, ID, PW 를 모두 입력해주세요!")
		...
		<div class="card p-4 my-3">
			...
			<div class="card-body">		
				<form id="joinForm" action="/member/join" method="post">
					...
					<div class="input-group mb-3">
						<input id="member_pw" class="form-control" type="password" name="member_pw" required="required" placeholder="비밀번호">
					</div>
